...
class Settings:
    ...
    video_demo_dir: Path = Path(os.getenv("CLOUD_VIDEO_DEMO_DIR", os.getenv("CLOUD_VIDEO_UPLOAD_DIR", "/root/video_project/uploads")))
    video_local_captures_dir: Path = Path(os.getenv("CLOUD_LOCAL_CAPTURES_DIR", str(Path(__file__).resolve().parent.parent.parent / "captures_local_delivery")))
